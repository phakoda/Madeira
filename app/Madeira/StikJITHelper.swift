...
enum StikJITHelper {
    ...
    /// Compatibility fallback. Current IPAs load madeira-jit.js from bundle resources.
    ...
    static func enableJIT(completion: @escaping (Bool) -> Void) {
        ...
        guard let url = StikJITRequest.url(bundleID: bundleId, scriptBase64: resolvedScriptBase64) else {
